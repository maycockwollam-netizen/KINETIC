...
Phase 5 :func:`~kinetic.tasks.policies.classify_failure` heuristic with the
...
from kinetic.intelligence.models import FailureAnalysis, TestFailureInfo
...
from kinetic.tasks.policies import FailureClass, classify_failure
