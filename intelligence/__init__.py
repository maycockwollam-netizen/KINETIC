...
from intelligence.analyzer import FailureAnalysis, FailureAnalyzer
from intelligence.diff import ChangeAnalysis, ChangeAnalyzer, ChangeRecord, GitInspector
...
from intelligence.regression import RegressionResult
