...
from kinetic.dependencies.detector import detect_dependencies
...
from kinetic.security.policy import DEPENDENCY_READ, ToolPermission
...
def _install_permission() -> ToolPermission:
    from kinetic.security.policy import DEPENDENCY_INSTALL
