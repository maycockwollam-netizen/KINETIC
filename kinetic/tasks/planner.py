...
malformed plans raise :class:`~kinetic.errors.PlanError` and are never
executed.
...
from kinetic.tasks.policies import validate_plan_bounds
...
def next_executable_step(plan: Plan) -> PlanStep | None:
    ...
    """
    from kinetic.tasks.models import StepStatus
